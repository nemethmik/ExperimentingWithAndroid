...
public class MainActivity extends AppCompatActivity {
    ...
    private void initPagedRecyclerView() {
        RecyclerView rv = findViewById(R.id.recyclerView);
        rv.setLayoutManager(new LinearLayoutManager(this));
        rv.setHasFixedSize(true);
        StackExchangeItemDataSource.ViewModel vm = ViewModelProviders.of(this).
                get(StackExchangeItemDataSource.ViewModel.class);
        final StackExchangeItemAdapter adapter = new StackExchangeItemAdapter();
        vm.mPagedList.observe(this, new Observer<PagedList<StackExchangeAnswers.Item>>() {
            @Override
            public void onChanged(@Nullable PagedList<StackExchangeAnswers.Item> items) {
