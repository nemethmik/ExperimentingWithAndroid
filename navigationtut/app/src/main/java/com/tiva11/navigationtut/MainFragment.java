...
import com.tiva11.navigationtut.databinding.FragmentMainBinding;
...
//    NavController navController;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_main, container, false); //Generated by the Project Wizard
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
// These complex listeners are not required, since the buttons send their destination fragment ids
// directly to the VM via data binding expressions.
// The VM emits messages via its LiveData channel, which is listened to by the main activity,
// and the actual navigation is invoked by the main activity via the navigation controller.
//        navController = Navigation.findNavController(view);
//        binding.viewTransactionsBtn.setOnClickListener(new View.OnClickListener() {
//            @Override
